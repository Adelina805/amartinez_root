    ...
    this.innerHTML = `
      <header class="site-header">
        ...
        <div class="nav-links-right">
          <svg class="theme-toggle" data-ambient-tip-group="toggle" width="24" height="23" viewBox="0 0 24 23" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="Light / Dark Mode Toggle Icon">
